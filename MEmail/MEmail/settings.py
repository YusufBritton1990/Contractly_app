"""
Django settings for MEmail project.
...
SECRET_KEY = 'f54!_=z51&0mfg^ld+kw-hi)r&obst3!0o*3vvkj#-gk8eu3y7'
...
ROOT_URLCONF = 'MEmail.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['/Users/Youth/Desktop/Django/MailChimp Campaign test/MEmail/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'MEmail.wsgi.application'
